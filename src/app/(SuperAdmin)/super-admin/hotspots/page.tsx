...
import { HotspotsPageComponent } from "@/components/super-admin/pages/hotspots-page.component";
  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        <h1 className="text-4xl font-bold">Hotspots Overview</h1>
        <Suspense fallback={<div>Loading metrics...</div>}>
          <HotspotsPageComponent />
        </Suspense>
      </div>
    </>
  );
